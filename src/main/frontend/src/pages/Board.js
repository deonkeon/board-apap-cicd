    ...
    <Container maxWidth="md" style={{ marginTop: "3%", textAlign: "center" }}>
      ...
      <form onSubmit={handleModify}>
        ...
        <Grid container style={{ marginTop: "3%", textAlign: "center" }}>
          ...
          <Grid item xs={10}>
            <Button type="button" variant="outlined" onClick={openFileInput}>
              파일 선택
            </Button>
            <input
              type="file"
        ...
        <Grid container style={{ marginTop: "3%", textAlign: "center" }}>
          ...
          <Grid item xs={10}>
            <Typography component="p" variant="string">
              파일을 변경하려면 사진을 클릭하시고 추가하려면 파일첨부 버튼을
              클릭하세요.
            </Typography>
                ...
                board.boardFileDTOList.map((boardFile, index) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        changeBoardFile(e, boardFile.boardFileNo)
                      }
                    ></input>
                    <img
                      style={{
                      ...
                      src={`https://kr.object.ncloudstorage.com/bitcamp-bucket-02/${boardFile.boardFilePath}${boardFile.boardFileName}`}
